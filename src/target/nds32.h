...
extern int nds32_cache_sync(struct target *target, target_ulong address, uint32_t length);
extern int nds32_mmu(struct target *target, int *enabled);
extern int nds32_virtual_to_physical(struct target *target, target_ulong address,
		target_ulong *physical);
extern int nds32_read_phys_memory(struct target *target, target_ulong address,
		uint32_t size, uint32_t count, uint8_t *buffer);
extern int nds32_write_phys_memory(struct target *target, target_ulong address,
		uint32_t size, uint32_t count, const uint8_t *buffer);
